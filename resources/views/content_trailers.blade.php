@extends('include.app')
@section('script')
<script src="{{ asset('assets/script/content_trailers.js') }}"></script>
@endsection
@section('content')
...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table id="trailerPostsTable" class="table table-centered table-hover w-100 dt-responsive nowrap mt-3">
