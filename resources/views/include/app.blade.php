        ...
        <div class="leftside-menu">
            ...
            <div class="h-100" id="leftside-menu-container" data-simplebar>
                ...
                <ul class="side-nav">
                    ...
                    <li class="side-nav-title">{{ __('Content')}}</li>
                    {{-- Music Videos --}}
                    <li class="side-nav-item contentMusic">
                        <a href="{{ url('contentMusic')}}" class="side-nav-link">
                            <i class="ri-mv-line"></i>
                            <span> {{ __('Music Videos')}} </span>
                        </a>
                    </li>
                    {{-- Trailers --}}
                    <li class="side-nav-item contentTrailers">
                        <a href="{{ url('contentTrailers')}}" class="side-nav-link">
                            <i class="ri-film-line"></i>
                            <span> {{ __('Trailers')}} </span>
                        </a>
                    </li>
                    {{-- News --}}
                    <li class="side-nav-item contentNews">
                        <a href="{{ url('contentNews')}}" class="side-nav-link">
                            <i class="ri-newspaper-line"></i>
                            <span> {{ __('News')}} </span>
                        </a>
                    </li>
                    {{-- Content Genres --}}
                    <li class="side-nav-item contentGenres">
                        <a href="{{ url('contentGenres')}}" class="side-nav-link">
                            <i class="ri-price-tag-3-line"></i>
                            <span> {{ __('Content Genres')}} </span>
                        </a>
                    </li>
                    {{-- Content Languages --}}
                    <li class="side-nav-item contentLanguages">
                        <a href="{{ url('contentLanguages')}}" class="side-nav-link">
                            <i class="ri-translate-2"></i>
                            <span> {{ __('Content Languages')}} </span>
                        </a>
                    </li>
                    {{-- Video Templates --}}
                    <li class="side-nav-item templates">
                        <a href="{{ url('templates')}}" class="side-nav-link">
                            <i class="ri-layout-grid-line"></i>
                            <span> {{ __('Templates')}} </span>
                        </a>
                    </li>
                    {{-- Green Screen Backgrounds --}}
                    <li class="side-nav-item greenScreenBgs">
                        <a href="{{ url('greenScreenBgs')}}" class="side-nav-link">
                            <i class="ri-image-fill"></i>
                            <span> {{ __('Green Screen')}} </span>
                        </a>
                    </li>
                    {{-- Live TV Channels --}}
                    <li class="side-nav-item liveChannels">
                        <a href="{{ url('liveChannels')}}" class="side-nav-link">
                            <i class="ri-live-line"></i>
                            <span> {{ __('Live TV')}} </span>
                        </a>
                    </li>
                    {{-- Short Stories / Series --}}
                    <li class="side-nav-item seriesAdmin">
                        <a href="{{ url('seriesAdmin')}}" class="side-nav-link">
                            <i class="ri-book-open-line"></i>
                            <span> {{ __('Short Stories')}} </span>
                        </a>
                    </li>
                    {{-- Paid Series --}}
                    <li class="side-nav-item paidSeriesAdmin">
                        <a href="{{ url('paidSeriesAdmin')}}" class="side-nav-link">
                            <i class="ri-vip-crown-line"></i>
                            <span> {{ __('Paid Series')}} </span>
                        </a>
                    </li>
                    {{-- Products / Shop --}}
                    <li class="side-nav-item productsAdmin">
                        <a href="{{ url('productsAdmin')}}" class="side-nav-link">
                            <i class="ri-shopping-bag-line"></i>
                            <span> {{ __('Products')}} </span>
                        </a>
                    </li>
                    <li class="side-nav-item productCategoriesAdmin">
                        <a href="{{ url('productCategoriesAdmin')}}" class="side-nav-link">
                            <i class="ri-list-check-2"></i>
                            <span> {{ __('Product Categories')}} </span>
                        </a>
                    </li>
                    <li class="side-nav-item productOrdersAdmin">
                        <a href="{{ url('productOrdersAdmin')}}" class="side-nav-link">
                            <i class="ri-shopping-cart-line"></i>
                            <span> {{ __('Product Orders')}} </span>
                        </a>
                    </li>
                    {{-- Marketplace --}}
                    <li class="side-nav-item marketplaceAdmin">
                        <a href="{{ url('marketplaceAdmin')}}" class="side-nav-link">
                            <i class="ri-store-2-line"></i>
                            <span> {{ __('Marketplace')}} </span>
                        </a>
                    </li>
                    {{-- Ad Revenue Share --}}
                    <li class="side-nav-item adRevenueAdmin">
                        <a href="{{ url('adRevenueAdmin')}}" class="side-nav-link">
                            <i class="ri-money-dollar-circle-line"></i>
                            <span> {{ __('Ad Revenue Share')}} </span>
                        </a>
                    </li>
                    <li class="side-nav-title">{{ __('Analytics')}}</li>
                    {{-- Platform Analytics --}}
                    <li class="side-nav-item analytics">
                        <a href="{{ url('analytics')}}" class="side-nav-link">
                            <i class="ri-bar-chart-2-line"></i>
                            <span> {{ __('Platform Analytics')}} </span>
                        </a>
                    </li>
