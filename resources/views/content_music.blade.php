@extends('include.app')
@section('script')
<script src="{{ asset('assets/script/content_music.js') }}"></script>
@endsection
@section('content')
...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table id="musicVideoPostsTable" class="table table-centered table-hover w-100 dt-responsive nowrap mt-3">
